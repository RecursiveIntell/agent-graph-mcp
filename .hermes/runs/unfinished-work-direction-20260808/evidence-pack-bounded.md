...
- Selection: first 3,200 characters of each of 12 workstream sections, with no model summarization.
...
3|## Mission
4|
5|You are implementing the P30 Codex super-pass for AiDENs. Your job is to harden AiDENs against the 2026-05-08 hostile aud
...
33|- **Agent action permission.** Rec
...
28|5. Require RED → minimal GREEN → targeted regression. A pre-existing green suite does not
...
50|- All system interactions are restricted
...
40|`name` claim. The full-name value is perce
